...
def place_board(
    ...
    since · until은 `YYYY-MM` 꼴이다. 달 단위로만 받는다 — 어느 동네를
    ...
    금액은 v_entries_net을 쓴다 — 다른 화면과 같은 잣대여야 한다.
